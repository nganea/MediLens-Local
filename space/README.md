...
- **MiniCPM-V 4.6** (vision OCR) - reads stylised medicine labels from a photo.
- **Tiny Aya Global (3B)** - rewrites and translates the explanation into the
  user's language at a 14-15 year-old reading level.
